...
namespace AServer
{
    public class Server
    {
        ...
        void Init()
        {
            ...
            args.Completed += new System.EventHandler<SocketAsyncEventArgs>(Accept);
            ServerSocket.AcceptAsync(args);

            SendNotice(); //서버한테 공지를 보내는 함수
        }
        ...
        void Accept(object? sender, SocketAsyncEventArgs e)
        {
            ...
            try
            {
                ...
                argsA.Completed += new System.EventHandler<SocketAsyncEventArgs>(Accept);
        ...
        void Received(object? sender, SocketAsyncEventArgs e) // (클라이언트 구분, 나머지 정보)
        {
